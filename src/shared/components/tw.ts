...
export const cardHeader = 'px-6 py-4 border-b border-gray-200 flex items-center justify-between';
...
export const modalHeader = 'flex items-center justify-between px-6 py-4 border-b border-gray-200';
export const modalTitle = 'text-xl font-semibold text-gray-900';
export const modalClose = 'text-gray-400 hover:text-gray-600 transition-colors';
export const modalBody = 'px-6 py-4 overflow-y-auto flex-1';
export const modalFooter = 'px-6 py-4 border-t border-gray-200 flex justify-end gap-3';

export const tableBase = 'min-w-full divide-y divide-gray-200';
export const tableHead = 'bg-gray-50';
export const tableHeaderCell = 'px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider';
